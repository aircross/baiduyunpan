...
unzip "BaiduPCS-Go-v3.7.3-linux-${ARCH}.zip"
mv "/BaiduPCS-Go-v3.7.3-linux-${ARCH}/BaiduPCS-Go" /BaiduPCS
rm -rf "BaiduPCS-Go-v3.7.3-linux-${ARCH}" "BaiduPCS-Go-v3.7.3-linux-${ARCH}.zip"
